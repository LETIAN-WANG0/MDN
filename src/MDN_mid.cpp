...
MDN::MDN()
{
    ...
    Wc = MatrixXd::Ones(input_length + GRU_Neuron_Num, GRU_Neuron_Num*2);
    bc = MatrixXd::Ones(GRU_Neuron_Num*2, 1);
    ...
    path_W0 = "/home/letian/MDN/Benchmark(copy)/newly_trained_MDN/MDN/Parameter/weights_h0.txt";
    path_b0 = "/home/letian/MDN/Benchmark(copy)/newly_trained_MDN/MDN/Parameter/bias_h0.txt";
    path_W1 = "/home/letian/MDN/Benchmark(copy)/newly_trained_MDN/MDN/Parameter/weights_h1.txt";
    path_b1 = "/home/letian/MDN/Benchmark(copy)/newly_trained_MDN/MDN/Parameter/bias_h1.txt";
    path_W2 = "/home/letian/MDN/Benchmark(copy)/newly_trained_MDN/MDN/Parameter/weights_h2.txt";
    path_b2 = "/home/letian/MDN/Benchmark(copy)/newly_trained_MDN/MDN/Parameter/bias_h2.txt";
    path_Wc = "/home/letian/MDN/Benchmark(copy)/newly_trained_MDN/MDN/Parameter/weights_rnn_candidate.txt";
    path_bc = "/home/letian/MDN/Benchmark(copy)/newly_trained_MDN/MDN/Parameter/bias_rnn_candidate.txt";
    path_WG = "/home/letian/MDN/Benchmark(copy)/newly_trained_MDN/MDN/Parameter/weights_rnn_gate.txt";
    path_bG = "/home/letian/MDN/Benchmark(copy)/newly_trained_MDN/MDN/Parameter/bias_rnn_gate.txt";
}
...
// c_prev: hidden(1,8) info, x: input(1,4), c: output
 ...
 const Eigen::MatrixXd& W0, const Eigen::MatrixXd& W1, const Eigen::MatrixXd& W2, const Eigen::VectorXd& b0, const Eigen::VectorXd& b1, const Eigen::VectorXd& b2)
{
	...
	GRU_Foward(Input, GRU_c,  GRU_output, WG, bG, Wc, bc);
